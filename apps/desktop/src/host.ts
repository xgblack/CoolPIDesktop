...
import type {ModelConfig,ModelEdit,ModelCatalog,ModelRolesConfig,ModelRolesEdit,ModelVerification} from '../../../packages/host-contract/src';
export const modelConfig={apply:()=>invoke<{applied:string[];skipped:string[];errors:{taskId:string;error:HostError}[]}>('model_config_apply'),load:()=>invoke<ModelConfig>('model_config_load'),save:(edit:ModelEdit)=>invoke<ModelConfig>('model_config_save',{edit}),rolesLoad:()=>invoke<ModelRolesConfig>('model_roles_load'),rolesSave:(edit:ModelRolesEdit)=>invoke<ModelRolesConfig>('model_roles_save',{edit}),catalog:()=>invoke<ModelCatalog>('model_catalog'),verify:(provider:string|null=null,modelId:string|null=null,projectId:string|null=null)=>invoke<ModelVerification>('model_config_verify',{provider,modelId,projectId})};
