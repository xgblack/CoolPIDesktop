...
export function App(){
 ...
 const side=<ProjectSidebar runtimeTasks={runtime.tasks} onRuntime={openRuntime} projects={w.projects} tasks={w.tasks} runs={w.runs} projectId={w.projectId} taskId={w.taskId} loading={w.loading} busy={w.busy} showArchived={archived} onArchived={setArchived}
