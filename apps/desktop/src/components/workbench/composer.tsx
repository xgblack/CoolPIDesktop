...
export function Composer({ thinking,onThinking,thinkingDisabled,taskId, draft, onDraft, onSend, onAbort, canSend, running, busy, disabledReason, modelDisabled=false, attachmentIds=[], onRemoveAttachment, modelLabel, onFiles, onContinue, onSettings, roots=[],references=[],onReferences,models=[],onModel,modelValue,modelsLoading,modelsError,onRefreshModels, approvalMode, onApprovalMode, approvalDisabled, approvalSwitching }: ComposerProps) {
