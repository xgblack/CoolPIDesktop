...
export function TaskHeader({task,run,busy,onSidebar,onStop,onRestart,onAbort,onRecovery,sidebarVisible,onDetails,detailsOpen,onBack,onForward}:{task:TaskRecord;run?:TaskSnapshot;busy:boolean;onSidebar:()=>void;onStop:()=>void;onRestart:()=>void;onAbort:()=>void;onRecovery:()=>void;sidebarVisible:boolean;onDetails?:()=>void;detailsOpen?:boolean;onBack?:()=>void;onForward?:()=>void}){
