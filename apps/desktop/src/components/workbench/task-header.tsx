import {PanelRight,Menu,MoreHorizontal,Square,RotateCcw,FolderOpen} from 'lucide-react';
...
export function TaskHeader({task,run,busy,onSidebar,onStop,onRestart,onAbort,onRecovery,sidebarVisible,onDetails,detailsOpen,onTrajectory,trajectoryOpen}:{task:TaskRecord;run?:TaskSnapshot;busy:boolean;onSidebar:()=>void;onStop:()=>void;onRestart:()=>void;onAbort:()=>void;onRecovery:()=>void;sidebarVisible:boolean;onDetails?:()=>void;detailsOpen?:boolean;onTrajectory?:()=>void;trajectoryOpen?:boolean}){
